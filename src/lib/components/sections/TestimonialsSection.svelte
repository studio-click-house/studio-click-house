...
<section
  ...
  class="section-space bg-brand-light text-brand-dark"
>
  <div class="site-shell grid gap-14 lg:grid-cols-12">
    <div class="lg:col-span-4">
      <p class="eyebrow text-brand-green font-semibold">Client notes</p>
      <h2
          ...
          {#each testimonials as testimonial (`${testimonial.name}-${testimonial.company}`)}
            ...
            >
              {#if testimonial.avatar}
                <div
                  class="size-16 md:size-20 shrink-0 rounded-full overflow-hidden border border-brand-green/40 bg-brand-dark/5"
                >
                  <img
