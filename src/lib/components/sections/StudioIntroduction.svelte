...
>
  ...
  <div class="site-shell">
    <div class="grid gap-12 lg:grid-cols-12 lg:gap-16">
      ...
      <div class="lg:col-span-4 flex flex-col justify-between border-t border-brand-dark/10 pt-8 lg:border-t-0 lg:pt-0">
        <div class="intro-fade">
          <div class="flex items-center gap-3">
            <span class="inline-block size-1.5 bg-brand-green" aria-hidden="true"></span>
            <p class="eyebrow text-brand-green">Studio introduction</p>
          </div>
          <p class="mt-8 max-w-xs font-mono text-[0.68rem] leading-relaxed uppercase tracking-[0.12em] text-brand-dark/65">
            [SCHL // EST. 2026]
            <span class="block mt-4 text-xs font-sans normal-case tracking-normal text-brand-dark/60">
              A focused post-production partner for people building campaigns, catalogs, editorial stories, and visual systems.
            </span>
          </p>
        </div>
      ...
      <div class="lg:col-span-8 border-t border-brand-dark/10 pt-8 lg:border-t-0 lg:pt-0">
        <h2
        ...
        >
          ...
          <span class="block overflow-hidden">
            <span class="title-line block">never <span class="italic text-brand-green">overpower</span></span>
          </span>
          <span class="block overflow-hidden">
        ...
        <div class="mt-12 grid gap-10 sm:grid-cols-12">
          ...
          <div class="intro-fade sm:col-span-7 space-y-6 text-sm sm:text-base leading-relaxed text-brand-dark/75">
            <p>
              Studio Click House supports image editing, retouching, and visual production with attention to material, light, color, and the way each frame belongs to the wider brand.
            </p>
            <p class="border-l-2 border-brand-green/30 pl-4 italic text-brand-dark/65">
              The work is collaborative and production-minded: understand the intended use, agree on a visual reference, then carry those decisions consistently through the set.
            </p>
          </div>
          
          <!-- Technical Specs Card -->
          <div class="intro-fade sm:col-span-5 flex flex-col justify-between border border-brand-dark/10 bg-brand-light/40 p-6 font-mono text-[0.62rem] uppercase tracking-[0.12em] text-brand-dark/50 shadow-sm">
            <div class="space-y-3">
              <p class="text-brand-green font-bold tracking-[0.15em]">Retouching Standards</p>
              <ul class="space-y-2 text-[0.58rem] normal-case text-brand-dark/70">
            ...
            <div class="mt-8 pt-4 border-t border-brand-dark/10 flex justify-between text-[0.56rem]">
              <span>System: 02</span>
              <span>EST. // 2026</span>
            </div>
          </div>
    ...
    <!-- Visual Collage Area -->
    <div class="mt-20 lg:mt-32 grid gap-16 lg:grid-cols-12 items-start relative">
      ...
      <div class="lg:col-span-7 relative">
        ...
        >
          <div class="overflow-hidden bg-brand-dark relative aspect-[4/5]">
            ...
            <span class="absolute left-3 top-3 bg-brand-dark px-2.5 py-1.5 font-mono text-[0.5rem] uppercase tracking-[0.14em] text-brand-light z-10">
              01 // EDITORIAL
            </span>
          </div>

          <div class="mt-4 flex justify-between font-mono text-[0.58rem] uppercase tracking-[0.14em] text-brand-dark/45">
        ...
        <span class="absolute -left-3 -top-3 size-8 border-l border-t border-brand-coral/60 pointer-events-none" aria-hidden="true"></span>
        <span class="absolute -right-3 -bottom-3 size-8 border-r border-b border-brand-green/60 pointer-events-none" aria-hidden="true"></span>
      </div>
      ...
      <div class="lg:col-span-5 space-y-12">
        ...
        >
          ...
          <div class="p-4 flex items-center justify-between font-mono text-[0.56rem] uppercase tracking-[0.12em] text-brand-dark/60">
        ...
        <div class="intro-fade space-y-4 max-w-[28rem] mx-auto lg:mx-0">
          <p class="font-display text-2xl sm:text-3xl tracking-tight text-brand-dark">
            Designed for scaling creative workflows.
          </p>
          <p class="text-sm leading-relaxed text-brand-dark/60">
            We operate at the intersection of photographic intent and digital execution. Our pipeline is custom-built to preserve color fidelity, contrast curves, and texture resolution across digital platforms, interactive layers, and high-fidelity print formats.
          </p>
        </div>
      </div>
