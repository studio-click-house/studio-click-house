        ...
        {#if activeService}
          <div class="preview-column" aria-live="polite">
            {#key activeService.slug}
              <BeforeAfterSlider
                beforeSrc={activeService.media.src}
                beforeAlt=""
                afterSrc={activeService.media.src}
                afterAlt={activeService.media.alt}
                width={activeService.media.width}
                height={activeService.media.height}
                beforeWidth={activeService.media.width}
                beforeHeight={activeService.media.height}
                ariaLabel={`Compare before and after for ${activeService.title}`}
                backLeftSrc={backLeftMedia?.src}
                backLeftWidth={backLeftMedia?.width}
                backLeftHeight={backLeftMedia?.height}
                backRightSrc={backRightMedia?.src}
                backRightWidth={backRightMedia?.width}
                backRightHeight={backRightMedia?.height}
              />
            {/key}
          </div>
        {/if}
