...
container.style.cssText =
  "position:absolute;top:10px;left:10px;color:white;background:rgba(0,0,0,0.5);padding:10px;font-family:monospace;";
...
function loadScene(sceneName) {
  ...
  // Load new scene
  const sceneAsset = new pc.Asset(sceneName, "scene", {
    url: `/${sceneName}.json`,
  });
...
```javascript
const criticalAssets = [playerModel, playerTexture, uiFont];
