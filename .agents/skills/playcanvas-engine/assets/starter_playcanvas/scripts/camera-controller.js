...
class CameraController {
  ...
  update(dt) {
    ...
    this.currentDistance +=
      (this.targetDistance - this.currentDistance) * this.damping;
    ...
    const x =
      this.target.x +
      this.currentDistance * Math.cos(pitchRad) * Math.sin(yawRad);
    const y = this.target.y + this.currentDistance * Math.sin(pitchRad);
    const z =
      this.target.z +
      this.currentDistance * Math.cos(pitchRad) * Math.cos(yawRad);
