...
mesh.subMeshes = [];
mesh.subMeshes.push(
  new BABYLON.SubMesh(0, 0, verticesCount, 0, indicesCount1, mesh),
);
mesh.subMeshes.push(
  new BABYLON.SubMesh(1, 0, verticesCount, indicesCount1, indicesCount2, mesh),
);
```
...
// Apply impulse
body.applyImpulse(new BABYLON.Vector3(0, 5, 0), new BABYLON.Vector3(0, 0, 0));
