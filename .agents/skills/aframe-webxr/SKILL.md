...
<a-entity id="rig" position="0 0 0">
  ...
  <a-entity hand-controls="hand: right" laser-controls="hand: right">
  </a-entity>
</a-entity>
```
...
```html
<a-entity
  light="type: point; color: #F00; intensity: 2; distance: 50"
  position="0 3 0"
></a-entity>
```
...
```html
<a-entity
  light="type: spot; angle: 45; intensity: 1.5"
  position="0 5 0"
  rotation="-90 0 0"
></a-entity>
```
...
<a-scene>
  ...
  <a-camera position="0 1.6 0">
    ...
    <a-cursor raycaster="objects: .interactive" fuse="true" fuse-timeout="1500">
    </a-cursor>
  </a-camera>
</a-scene>
...
<html>
  ...
  <body>
    <a-scene>
      <!-- Gradient sky -->
      <a-sky-background top-color="#4A90E2" bottom-color="#87CEEB">
      </a-sky-background>
...
<script>
  ...
  document
    .querySelector('[gltf-model="#robot"]')
  ...
  document
    .querySelector('[gltf-model="#robot"]')
    .addEventListener("model-error", (evt) => {
